...
class ReservationRepository extends ServiceEntityRepository
{
     ...
     * @return list<Reservation>
     */
    public function findConfirmedOverlapping(Property $property, \DateTimeImmutable $checkin, \DateTimeImmutable $checkout): array
    {
        return $this->createQueryBuilder('r')
     ...
     * @return list<Reservation>
     */
    public function findByPropertyForCalendar(Property $property): array
    {
        return $this->createQueryBuilder('r')
            ->where('r.property = :property')
            ->andWhere('r.status IN (:statuses)')
