...
#[AsMessageHandler]
final readonly class ReservationCancelledNotificationHandler
{
    ...
    public function __invoke(ReservationCancelledNotification $message): void
    {
        ...
        $this->notifier->cancelled($reservation);
    }
}
